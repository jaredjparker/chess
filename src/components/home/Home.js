    ...
    render() {
        return (
            <div id='home-page'>
                ...
                <div className='md-scrn'>
                    <p>Thank you for visiting.&nbsp; Unfortunately your screen size is too small for this application.&nbsp; Please open this application on a screen 1000px or bigger.</p>
                </div>
